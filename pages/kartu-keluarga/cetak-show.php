...
class PDF extends FPDF
{
    ...
    {
      // Logo
      $this->Image('../../assets/img/papua.jpg', 20,10);
    	...
    	// $this->Cell(60);
    	// Title
        $this->Cell(308,10,'PENGURUS RT. 003 RW 016',0,1,'C');
        $this->Cell(308,10,'KEL. ANGGER PERMEGI, KEC. JAGEBOB' ,0,1,'C');
    	$this->Cell(308,8,'PAPUA SELATAN',0,1,'C');
    	// Line break
    	$this->Ln(5);
